...
function showrecentposts1(json) {
    ...
    for (var i = 0; i < maxpost; i++) {
        ...
        if( today2.getTime() < new Date(postdate).getTime()){ 
...
function related_results_labels_thumbs(json) {
    for (var i = 0; i < json.feed.entry.length; i++) {
        ...
        try {
            ...
            if(thumburl[relatedTitlesNum].search("youtube") != -1){
                thumburl[relatedTitlesNum] =  thumburl[relatedTitlesNum].replace("default", "0"); 
            }else{
